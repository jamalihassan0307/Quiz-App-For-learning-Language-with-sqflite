...
final hindiQuestionsList = [
  Question(
    ...
    options: [
      ...
      const Option(text: "चेरी", isCorrect: false),
      const Option(text: "अंगूर", isCorrect: false),
    ],
    id: 0,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "गुड डे", isCorrect: false),
    ],
    id: 1,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "धन्यवाद", isCorrect: true),
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "मेज", isCorrect: false),
      const Option(text: "खिड़की", isCorrect: false),
    ],
    id: 3,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "आप कहां हैं?", isCorrect: false),
      const Option(text: "आप कब आएंगे?", isCorrect: false),
    ],
    id: 4,
  ...
  Question(
    ...
    options: [
      const Option(text: "नमस्ते", isCorrect: false),
      const Option(text: "गुड इवनिंग", isCorrect: false),
      const Option(text: "अलविदा", isCorrect: true),
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "सूखा", isCorrect: false),
      const Option(text: "गीला", isCorrect: false),
    ],
    id: 6,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "बच्चों के", isCorrect: false),
      const Option(text: "बच्चों को", isCorrect: false),
    ],
    id: 7,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "कार", isCorrect: false),
      const Option(text: "बगीचा", isCorrect: false),
    ],
    id: 8,
  ...
  Question(
    ...
    options: [
      const Option(text: "धन्यवाद", isCorrect: false),
      const Option(text: "मुझे माफ करें", isCorrect: false),
      const Option(text: "कृपया", isCorrect: true),
      const Option(text: "नमस्ते", isCorrect: false),
    ],
    id: 9,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "पानी", isCorrect: true),
      const Option(text: "धरती", isCorrect: false),
    ],
    id: 10,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "मुझे आपसे प्यार है", isCorrect: true),
      const Option(text: "आप अच्छे हैं", isCorrect: false),
    ],
    id: 11,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "जान-पहचान वाला", isCorrect: false),
      const Option(text: "रिश्तेदार", isCorrect: false),
    ],
    id: 12,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "छोटा", isCorrect: false),
      const Option(text: "आधुनिक", isCorrect: false),
    ],
    id: 13,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "रिश्तेदार", isCorrect: false),
      const Option(text: "जान-पहचान वाले", isCorrect: false),
    ],
    id: 14,
