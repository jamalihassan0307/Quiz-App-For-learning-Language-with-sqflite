...
final englishQuestionsList = [
  Question(
    ...
    options: [
      ...
      const Option(text: "gone", isCorrect: false),
      const Option(text: "goes", isCorrect: false),
    ],
    id: 0,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "joyful", isCorrect: true),
      const Option(text: "tired", isCorrect: false),
    ],
    id: 1,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "small", isCorrect: true),
      const Option(text: "massive", isCorrect: false),
    ],
    id: 2,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "childes", isCorrect: false),
      const Option(text: "childrens", isCorrect: false),
    ],
    id: 3,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "recievee", isCorrect: false),
      const Option(text: "recive", isCorrect: false),
    ],
    id: 4,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "happiness", isCorrect: true),
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "better", isCorrect: false),
      const Option(text: "most good", isCorrect: false),
    ],
    id: 6,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "singing", isCorrect: false),
      const Option(text: "sung", isCorrect: true),
    ],
    id: 7,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "Paris", isCorrect: true),
      const Option(text: "river", isCorrect: false),
    ],
    id: 8,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "happily", isCorrect: false),
      const Option(text: "joy", isCorrect: false),
    ],
    id: 9,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "be", isCorrect: false),
    ],
    id: 10,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "speed", isCorrect: false),
      const Option(text: "rapid", isCorrect: false),
    ],
    id: 11,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "hard", isCorrect: true),
      const Option(text: "light", isCorrect: false),
    ],
    id: 12,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "mice", isCorrect: true),
      const Option(text: "mices", isCorrect: false),
    ],
    id: 13,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "sees", isCorrect: false),
      const Option(text: "see", isCorrect: false),
    ],
    id: 14,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "cool", isCorrect: false),
      const Option(text: "burn", isCorrect: false),
    ],
    id: 15,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "better", isCorrect: true),
      const Option(text: "most good", isCorrect: false),
    ],
    id: 17,
  ...
  Question(
    ...
    options: [
      ...
      const Option(text: "eaten", isCorrect: true),
      const Option(text: "eating", isCorrect: false),
    ],
    id: 19,
    correctAnswer: const Option(text: "eaten", isCorrect: true),
  ),
];
